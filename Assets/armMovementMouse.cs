	...
	void Update () {
		...
		if(!gameOver){
			...
			for(int i = 0; i < this.planets.Length ; i++){
				...
				if(this.getDistance(this.planets[i]) <= curCollider.radius * ( this.planets[i].transform.lossyScale.x +  this.planets[i].transform.lossyScale.y   + this.planets[i].transform.lossyScale.z ) / 3.0f){
					gameOver = true;
			...
			for(int i = 0; i < this.stars.Length ; i++){
				...
				if(this.getDistance(this.stars[i]) <= curCollider.radius * ( this.stars[i].transform.localScale.x +  this.stars[i].transform.localScale.y   + this.stars[i].transform.localScale.z ) / 3.0f){
					gameOver = true;
			...
			for(int i = 0; i < this.blackholes.Length ; i++){
				...
				if(this.getDistance(this.blackholes[i]) <= curCollider.radius * ( this.blackholes[i].transform.localScale.x +  this.blackholes[i].transform.localScale.y   + this.blackholes[i].transform.localScale.z ) / 3.0f){
					gameOver = true;
